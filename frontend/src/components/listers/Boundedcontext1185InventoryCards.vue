    ...
    <div>
        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    <Boundedcontext1185Inventory :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" 
        ...
        <v-row>
            <Boundedcontext1185Inventory :offline="offline" class="video-card" v-for="(value, index) in values" v-model="values[index]" v-bind:key="index" @delete="remove"/>
        </v-row>
    </div>
</template>
...
<script>
    ...
    import Boundedcontext1185Inventory from './../Boundedcontext1185Inventory.vue';

    export default {
        name: 'Boundedcontext1185InventoryManager',
        components: {
            Boundedcontext1185Inventory,
        },
        props: {
            offline: Boolean
        },
