    ...
    <div>
        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    <Boundedcontext156Order :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" 
        ...
        <v-row>
            <Boundedcontext156Order :offline="offline" class="video-card" v-for="(value, index) in values" v-model="values[index]" v-bind:key="index" @delete="remove"/>
        </v-row>
    </div>
</template>
...
<script>
    ...
    import Boundedcontext156Order from './../Boundedcontext156Order.vue';

    export default {
        name: 'Boundedcontext156OrderManager',
        components: {
            Boundedcontext156Order,
        },
        props: {
            offline: Boolean
        },
