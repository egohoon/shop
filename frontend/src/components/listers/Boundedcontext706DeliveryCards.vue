    ...
    <div>
        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    <Boundedcontext706Delivery :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" 
        ...
        <v-row>
            <Boundedcontext706Delivery :offline="offline" class="video-card" v-for="(value, index) in values" v-model="values[index]" v-bind:key="index" @delete="remove"/>
        </v-row>
    </div>
</template>
...
<script>
    ...
    import Boundedcontext706Delivery from './../Boundedcontext706Delivery.vue';

    export default {
        name: 'Boundedcontext706DeliveryManager',
        components: {
            Boundedcontext706Delivery,
        },
        props: {
            offline: Boolean
        },
